...
{{- if and (has .component (list "ingester" "alertmanager")) $componentSection.zone_aware_replication.migration.enabled (not $componentSection.zone_aware_replication.migration.write_path) -}}
